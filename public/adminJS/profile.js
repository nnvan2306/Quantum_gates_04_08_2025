            ...
            stats = [
                {
                    ...
                    value: result.data.users.total,
                    icon: "fas fa-users",
                    color: "primary",
                },
                {
                    label: "Tổng bài viết",
                    value: result.data.posts.total,
                    icon: "fas fa-newspaper",
                    color: "success",
                },
                {
                    label: "Tương tác hôm nay",
                    value: result.data.interactions.today,
            ...
            stats = [
                {
                    ...
                    value: postStats.data.pagination.total,
                    icon: "fas fa-newspaper",
                    color: "primary",
                },
                {
